...
using XamarinProjectSimple.Models;

[assembly: Xamarin.Forms.Dependency(typeof(XamarinProjectSimple.Services.MockDataStore))]
namespace XamarinProjectSimple.Services
{
    public class MockDataStore : IDataStore<Item>
    {
        ...
        public MockDataStore()
        {
            ...
            {
                new Item { Id = Guid.NewGuid().ToString(), Name = "Спортмастер", Description="This is an item description." },
